...
def tela_cadastro(page: ft.Page):
    ...
    logo = ft.Image(
        src=r"C:\Users\wands\OneDrive\Documentos\taskzen\icon.png",
        width=80,
        height=80,
    ...
    page.add(
        ft.Column(
            [
                ...
                criterio_minuscula,
                criterio_numero,
                # Adicionando os botões em um Row para melhor posicionamento
                ft.Row(
                    [
                        btn_cadastrar,  # Botão Cadastrar
                    ],
                    alignment=ft.MainAxisAlignment.CENTER,
                    spacing=10,  # Espaçamento entre os botões
                ),
                # Adicionar botão Voltar como um elemento logo abaixo
                ft.Row(
                    [
                        btn_voltar,  # Botão Voltar
                    ],
                    alignment=ft.MainAxisAlignment.CENTER,
                    spacing=10,  # Espaçamento ajustado
                ),
                msg_feedback,
            ],
            alignment=ft.MainAxisAlignment.START,
            horizontal_alignment=ft.CrossAxisAlignment.CENTER,
            spacing=15,  # Reduzi o espaçamento geral para otimizar o layout
            expand=True,
        )
    )
